...
# Combined HTML/CSS/JS Frontend Template
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
def predict():
    if not vectorizer or not model:
        return jsonify({'error': 'Model files not loaded properly on the server.'}), 500
    ...
    try:
        ...
        # Adjust label naming mapping to fit your exact targets if needed
